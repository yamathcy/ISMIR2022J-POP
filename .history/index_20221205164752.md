...
<div style="text-align: center;">
    <img src="decompose.png" width="600px">
</div>
Now, let’s think about the role of singing techniques. 
It is produced by a singer, and the singer sings a song, which consists of melody and lyrics. In addition, the singer determines how to express the song.

In other words, that is **when and which kind of techniques are applied.**
As such, by determining who sings what song, and how to express it, then a vocal performance is rendered. Therefore, singing techniques play an crucial role in vocal performance as well as vocalist and song.
